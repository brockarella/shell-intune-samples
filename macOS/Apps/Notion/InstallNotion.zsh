...
############################################################################################
##
## Script to install the latest Notion
## 
## VER 4.0.5
##
## Change Log
...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    weburl="https://www.notion.so/desktop/mac-universal/download" 
    else
    # This is x64 URL
    weburl="https://desktop-release.notion-static.com/Notion-3.12.0-universal.dmg"   
fi

appname="Notion"                                                      # The name of our App deployment script (also used for Octory monitor)
app="Notion.app"                                                      # The actual name of our App once installed
...
processpath="$appdir/$app/Contents/MacOS/Notion"                      # The process name of the App we are installing
